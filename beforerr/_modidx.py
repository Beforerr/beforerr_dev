...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'beforerr.basics': {'beforerr.basics.pmap': ('basics.html#pmap', 'beforerr/basics.py')},
            ...
            'beforerr.io': { 'beforerr.io.action': ('io.html#action', 'beforerr/io.py'),
                             'beforerr.io.applicable_func': ('io.html#applicable_func', 'beforerr/io.py'),
                             'beforerr.io.checkpath': ('io.html#checkpath', 'beforerr/io.py'),
                             'beforerr.io.query_datatype': ('io.html#query_datatype', 'beforerr/io.py')},
            'beforerr.io.json': {},
