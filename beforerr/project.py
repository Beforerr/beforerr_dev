...
# %% auto 0
__all__ = ['projectdir', 'datadir', 'setup_run_dir', 'savename', 'append_prefix_suffix', 'safesave', 'produce_or_load']
...
def produce_or_load(
    ...
    force: bool = False,
    verbose: bool = True,
    wsave_kwargs: dict = None,
    wload_kwargs: dict = None,
    filename: Union[Callable, str] = None,
    **kwargs,
) -> Tuple[Any, str]:
    if wsave_kwargs is None:
        wsave_kwargs = {}
    if wload_kwargs is None:
        wload_kwargs = {}
